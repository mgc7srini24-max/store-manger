...
const Inventory = () => {
    ...
    return (
        <div className="m-2 mb-4 flex flex-col items-center">
            <h1 className="font-bold text-4xl mx-2">INVENTORY</h1>
            <div className="m-2 mb-3 w-full max-w-md flex items-center gap-2">
                ...
                <div className="flex items-center">
                    ...
                    <input
                        id="alert-value"
                        className="border p-2 hover:border-cyan-400 rounded w-20"
                        value={alertValue}
                        type="number"
            ...
            {filteredInventory.length > 0 ? (
                ...
                <p className="m-2 text-red-500 font-bold">No inventory items found.</p>
            )}
        </div>
    );
};
