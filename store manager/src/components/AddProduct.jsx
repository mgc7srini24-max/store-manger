        ...
        <div className="max-w-md mx-auto p-6 bg-white shadow-lg rounded-lg mt-6 mb-4">
            ...
            <form onSubmit={onAddProduct} className="space-y-4">
                <div>
                    <label
                        htmlFor="productName"
                        className="block text-sm font-sans-serif text-gray-700"
                    >
                        Product Name
                    </label>
                    <input
                        id="productName"
                        type="text"
                        className="w-full p-2 border rounded focus:ring focus:ring-yellow-300 focus:outline-none"
                ...
                <div>
                    <label
                        htmlFor="imageUrl"
                        className="block text-sm font-sans-serif text-black-700"
                    >
                        Product Image URL
                    </label>
                    <input
                ...
                <div className="text-center">
                    <button
                        type="submit"
                        className="w-full bg-yellow-400 text-black font-Cravend, sans-serif py-2 px-4 rounded hover:bg-yellow-500 transition"
                    >
                       Add Product
                    </button>
                </div>
