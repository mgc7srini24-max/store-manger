...
export default function Cart() {
    ...
    return (
        <div className="m-2 flex flex-col items-center">
            ...
            {count === 0 ? (
                <p className="text-lg text-red-600 mx-2 font-bold">Your cart is empty.</p>
            ) : (
                <div>
                    <p className="mx-2">
                        ...
                        }} className="bg-yellow-500 hover:bg-yellow-600 text-black rounded p-1 m-1 mx-3">Checkout Cart</button>
                        <button onClick={() => {
                            cartDispatch({
                                type: 'EMPTY_CART',
                            });
                        }} className="bg-red-600 hover:bg-red-700 text-white rounded p-1 m-1 mx-2">Clear Cart</button>
                    </p>
